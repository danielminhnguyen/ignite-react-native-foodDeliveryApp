...
import { Image, StyleSheet, View, ViewStyle, TouchableOpacity, Animated } from "react-native"
...
export const RestaurantScreen = observer(function RestaurantScreen({ route }) {
          ...
          <View key={`menu-${index}`} style={{ alignItems: "center" }}>
            <View style={{ height: SIZES.height * 0.35 }}>
              ...
              >
                ...
                >
                  <Text style={{ ...FONTS.h2 }}>{getOrderQty(item.menuId) || 0}</Text>
                </View>
    ...
    return (
      <View>
        ...
        >
          ...
          {/* Order Button */}
          <View
            style={{ padding: SIZES.padding * 2, alignItems: "center", justifyContent: "center" }}
          >
            <TouchableOpacity
              style={{
