...
export const OrderDeliveryScreen = observer(function OrderDeliveryScreen({ route }) {
  ...
  function renderMap() {
    ...
    const carIcon = () => {
      if (fromLocation) {
        return (
          <Marker coordinate={fromLocation} anchor={{ x: 0.5, y: 0.5 }} flat rotation={angle}>
